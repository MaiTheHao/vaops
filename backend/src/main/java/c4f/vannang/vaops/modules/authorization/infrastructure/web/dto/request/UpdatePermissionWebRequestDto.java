...
@Schema(description = "Request body for updating an existing permission")
public record UpdatePermissionWebRequestDto(
        ...
        @Schema(description = "Permission action name", example = "UPDATE")
        @NotBlank(message = "action is required")
        @Size(max = 256, message = "action must not exceed 256 characters")
        String action,

        @Schema(description = "Detailed permission description", example = "Allows updating user profiles")
