...
public class PermissionController {
  ...
  public ResponseEntity<PageResponse<PermissionWebResponseDto>> searchPermissions(
      ...
      @Parameter(name = "resource", description = "Filter by resource") @RequestParam(name = "resource", required = false) String resource,
      @Parameter(name = "action", description = "Filter by action") @RequestParam(name = "action", required = false) String action,
      @Parameter(name = "isActive", description = "Filter by active status") @RequestParam(name = "isActive", required = false) Boolean isActive,
      @Parameter(name = "roleIds", description = "Filter by assigned role IDs") @RequestParam(name = "roleIds", required = false) Collection<UUID> roleIds,
